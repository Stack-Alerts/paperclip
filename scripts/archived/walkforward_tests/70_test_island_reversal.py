"""
Walk-Forward Test for Island Reversal
...
def test_block_walkforward_v2(block_class, block_kwargs, block_name: str, df_full: pd.DataFrame):
    ...
    active_signals = [s for s in signals if s not in ['NO_PATTERN', 'NEUTRAL', 'INSUFFICIENT_DATA', 'ERROR']]
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.island_reversal import IslandReversal
