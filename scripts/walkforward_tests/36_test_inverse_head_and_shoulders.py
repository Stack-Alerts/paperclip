"""
Walk-Forward Test for Inverse Head And Shoulders
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.inverse_head_and_shoulders import InverseHeadAndShoulders
    
    print("Loading 180 days of BTC 15min data...")
    df = load_btc_data(days=180)
    
    if df is not None and len(df) > 0:
        block = InverseHeadAndShoulders()
        test_block_walkforward_v2(block, "inverse_head_and_shoulders", df)
    else:
