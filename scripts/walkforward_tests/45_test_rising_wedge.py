"""
Walk-Forward Test for Rising Wedge
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.rising_wedge import RisingWedge
    ...
    if df is not None and len(df) > 0:
        block = RisingWedge()
        test_block_walkforward_v2(block, "rising_wedge", df)
    else:
