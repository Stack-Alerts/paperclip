...
if __name__ == "__main__":
    from src.detectors.building_blocks.sessions.asia_session_50_percent import AsiaSession50Percent
    ...
    if df is not None and len(df) > 0:
        ...
        test_block_walkforward(block, "asia_session_50_percent", df)
    else:
