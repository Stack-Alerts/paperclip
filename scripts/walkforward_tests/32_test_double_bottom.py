"""
Walk-Forward Test for Double Bottom
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.double_bottom import DoubleBottom
    ...
    if df is not None and len(df) > 0:
        block = DoubleBottom()
        test_block_walkforward_v2(block, "double_bottom", df)
    else:
