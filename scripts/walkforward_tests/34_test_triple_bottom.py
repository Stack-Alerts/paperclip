"""
Walk-Forward Test for Triple Bottom
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.triple_bottom import TripleBottom
    ...
    if df is not None and len(df) > 0:
        block = TripleBottom()
        test_block_walkforward_v2(block, "triple_bottom", df)
    else:
