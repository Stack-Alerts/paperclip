"""
Walk-Forward Test for Initial Balance Breakout
...
def test_block_walkforward_v2(block_class, block_kwargs, block_name: str, df_full: pd.DataFrame):
    ...
    active_signals = [s for s in signals if s not in ['NEUTRAL', 'INSUFFICIENT_DATA', 'ERROR', 'NO_PATTERN', 'NO_ORDER_BLOCK', 'NO_BREAK', 'NO_SWEEP', 'NO_FVG', 'NO_DISPLACEMENT', 'NO_INDUCEMENT', 'NO_OTE', 'NO_CHOCH', 'NO_MSS', 'NO_IB']]
...
if __name__ == "__main__":
    ...
    if df is not None and len(df) > 0:
        ...
        test_block_walkforward_v2(
            ...
            {'ib_duration_minutes': 120, 'volume_threshold': 1.3},
