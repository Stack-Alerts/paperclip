"""
Walk-Forward Test for Cup And Handle
...
if __name__ == "__main__":
    from src.detectors.building_blocks.patterns.cup_and_handle import CupAndHandle
    ...
    if df is not None and len(df) > 0:
        block = CupAndHandle()
        test_block_walkforward_v2(block, "cup_and_handle", df)
    else:
