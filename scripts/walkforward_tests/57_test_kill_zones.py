"""
Walk-Forward Test for Kill Zones
...
if __name__ == "__main__":
    from src.detectors.building_blocks.market_structure.kill_zones import KillZones
    ...
    if df is not None and len(df) > 0:
        block = KillZones()
        test_block_walkforward(block, "kill_zones", df)
    else:
