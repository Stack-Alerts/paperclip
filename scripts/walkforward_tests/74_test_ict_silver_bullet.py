"""
Walk-Forward Test for ICT Silver Bullet
...
def test_block_walkforward_v2(block_class, block_kwargs, block_name: str, df_full: pd.DataFrame):
    ...
    active_signals = [s for s in signals if s not in ['NEUTRAL', 'INSUFFICIENT_DATA', 'FVG_PRESENT', 'ERROR']]
...
if __name__ == "__main__":
    from src.detectors.building_blocks.signals.ict_silver_bullet import ICTSilverBullet
