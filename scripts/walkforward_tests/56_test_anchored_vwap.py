"""
Walk-Forward Test for Anchored VWAP
...
if __name__ == "__main__":
    from src.detectors.building_blocks.supply_demand.anchored_vwap import AnchoredVWAP
    ...
    if df is not None and len(df) > 0:
        block = AnchoredVWAP()
        test_block_walkforward(block, "anchored_vwap", df)
    else:
