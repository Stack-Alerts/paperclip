"""
Regression tests for BTCAAAAA-25923: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25923
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25923"),
