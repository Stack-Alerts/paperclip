"""
Regression tests for BTCAAAAA-25392: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25392
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25392"),
