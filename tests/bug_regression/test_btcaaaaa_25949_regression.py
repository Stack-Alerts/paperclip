"""
Regression tests for BTCAAAAA-25949: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25949
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25949"),
