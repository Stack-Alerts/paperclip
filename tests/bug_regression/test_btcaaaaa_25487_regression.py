"""
Regression tests for BTCAAAAA-25487: Blast Radius worker -- detect fix->in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25487
...
This file re-exports the existing unit tests from test_worker.py so the Impact
Gate runner can discover them by bug ID.  The canonical tests live in
tests/test_blast_radius/ and must not drift.
"""
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25487"),
