"""Regression tests for BTCAAAAA-25902: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25902
...
scheduled runs with a 7-day look-back window.  The _is_fix_issue classifier
correctly excludes scan-done issues whose titles contain the word "fix"
("Impact Gate: scan for fix issues done") from the fix-issue set to prevent
self-flagging.
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25902"),
