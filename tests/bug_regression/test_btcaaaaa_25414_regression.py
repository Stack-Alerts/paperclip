"""
Regression tests for BTCAAAAA-25414: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25414
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25414"),
