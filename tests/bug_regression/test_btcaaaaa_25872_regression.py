"""
Regression tests for BTCAAAAA-25872: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25872
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25872"),
