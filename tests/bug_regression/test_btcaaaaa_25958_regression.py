"""
Regression tests for BTCAAAAA-25958: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25958
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25958"),
