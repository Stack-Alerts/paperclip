"""
Regression tests for BTCAAAAA-25451: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25451
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25451"),
