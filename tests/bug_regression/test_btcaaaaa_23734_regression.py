"""
Regression tests for BTCAAAAA-23734: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-23734
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-23734"),
