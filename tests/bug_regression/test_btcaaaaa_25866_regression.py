"""
Regression tests for BTCAAAAA-25866: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25866
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25866"),
