"""Regression tests for BTCAAAAA-25844: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25844
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25844"),
