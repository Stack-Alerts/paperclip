"""
Regression tests for BTCAAAAA-25908: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25908
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25908"),
