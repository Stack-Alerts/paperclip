"""
Regression tests for BTCAAAAA-25574: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25574
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25574"),
