"""
Regression tests for BTCAAAAA-25422: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25422
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25422"),
