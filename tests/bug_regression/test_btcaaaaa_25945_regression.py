"""
Regression tests for BTCAAAAA-25945: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25945
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25945"),
