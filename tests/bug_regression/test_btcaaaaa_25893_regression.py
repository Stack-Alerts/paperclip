"""
Regression tests for BTCAAAAA-25893: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25893
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25893"),
