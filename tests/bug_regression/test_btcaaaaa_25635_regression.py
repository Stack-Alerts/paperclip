"""
Regression tests for BTCAAAAA-25635: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25635
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25635"),
