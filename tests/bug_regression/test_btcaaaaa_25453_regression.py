"""
Regression tests for BTCAAAAA-25453: Blast Radius worker -- detect fix->in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25453
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25453"),
