"""
Regression tests for BTCAAAAA-25901: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25901
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25901"),
