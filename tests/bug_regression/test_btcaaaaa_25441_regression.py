"""
Regression tests for BTCAAAAA-25441: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25441
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25441"),
