"""
Regression tests for BTCAAAAA-25857: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25857
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25857"),
