"""Regression tests for BTCAAAAA-25887: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25887
...
This is the parent orchestration issue that completed the full Blast Radius
worker implementation, including the polling worker, report generator, query
engine, HTTP API server, CI/CD pipelines, monitoring/alerting, and runbook
documentation.
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25887"),
