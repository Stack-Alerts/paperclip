"""
Regression tests for BTCAAAAA-25665: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25665
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25665"),
