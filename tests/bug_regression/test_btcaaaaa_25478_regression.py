"""
Regression tests for BTCAAAAA-25478: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25478
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25478"),
