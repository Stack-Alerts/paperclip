"""
Regression tests for BTCAAAAA-25843: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25843
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25843"),
