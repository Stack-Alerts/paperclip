"""Regression tests for BTCAAAAA-25846: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25846
...
shims (BTCAAAAA-25834, BTCAAAAA-25840).
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25846"),
