"""
Regression tests for BTCAAAAA-25442: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25442
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25442"),
