"""
Regression tests for BTCAAAAA-25842: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25842
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25842"),
