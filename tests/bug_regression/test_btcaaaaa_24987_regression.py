"""
Regression tests for BTCAAAAA-24987: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-24987
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-24987"),
