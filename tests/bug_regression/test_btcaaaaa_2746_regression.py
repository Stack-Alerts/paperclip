"""
Regression tests for BTCAAAAA-2746: add missing bug regression test file for
BTCAAAAA-1402.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2746
...
the file for BTCAAAAA-1402 that was missing from the set of committed bug
