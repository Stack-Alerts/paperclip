"""
Regression tests for BTCAAAAA-23724: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-23724
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-23724"),
