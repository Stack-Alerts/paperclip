"""
Regression tests for BTCAAAAA-25850: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25850
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25850"),
