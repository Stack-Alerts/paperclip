"""
Regression tests for BTCAAAAA-25393: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25393
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25393"),
