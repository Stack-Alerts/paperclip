"""
Regression tests for BTCAAAAA-25339: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25339
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25339"),
