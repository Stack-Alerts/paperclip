"""
Regression tests for BTCAAAAA-25649: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25649
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25649"),
