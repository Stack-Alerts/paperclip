"""
Regression tests for BTCAAAAA-23731: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-23731
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-23731"),
