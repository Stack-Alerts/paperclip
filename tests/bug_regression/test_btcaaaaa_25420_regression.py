"""
Regression tests for BTCAAAAA-25420: Blast Radius worker -- detect fix->in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25420
...
test_main.py, test_runner.py, and test_cli.py so the Impact Gate runner can
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25420"),
