"""
Regression tests for BTCAAAAA-25934: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25934
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25934"),
