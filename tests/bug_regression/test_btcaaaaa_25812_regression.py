"""
Regression tests for BTCAAAAA-25812: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25812
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25812"),
