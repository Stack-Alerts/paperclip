"""
Regression tests for BTCAAAAA-25806: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25806
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25806"),
