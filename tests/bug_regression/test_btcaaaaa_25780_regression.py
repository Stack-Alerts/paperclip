"""
Regression tests for BTCAAAAA-25780: Blast Radius worker -- detect fix->in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25780
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25780"),
