"""
Regression tests for BTCAAAAA-2750: add missing bug regression test file for
BTCAAAAA-1721.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2750
...
the file for BTCAAAAA-1721 that was missing from the set of committed bug
