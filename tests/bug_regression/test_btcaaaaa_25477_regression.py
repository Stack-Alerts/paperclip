"""
Regression tests for BTCAAAAA-25477: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25477
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25477"),
