"""
Regression tests for BTCAAAAA-25915: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25915
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25915"),
