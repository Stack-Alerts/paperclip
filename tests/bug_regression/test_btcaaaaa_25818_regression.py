"""
Regression tests for BTCAAAAA-25818: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25818
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25818"),
