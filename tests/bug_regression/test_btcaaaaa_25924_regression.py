"""
Regression tests for BTCAAAAA-25924: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25924
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25924"),
