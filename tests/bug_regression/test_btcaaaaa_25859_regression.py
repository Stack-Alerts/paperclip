"""Regression tests for BTCAAAAA-25859: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25859
...
enabled on scheduled runs with a 7-day look-back window.  This is the top-level
orchestration issue that spawned child issues for individual regression test
shims (BTCAAAAA-25846, BTCAAAAA-25853, BTCAAAAA-25840).
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25859"),
