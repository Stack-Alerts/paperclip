"""
Regression tests for BTCAAAAA-2748: add missing bug regression test file for
BTCAAAAA-1448.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2748
...
the file for BTCAAAAA-1448 that was missing from the set of committed bug
