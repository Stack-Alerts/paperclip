"""
Regression tests for BTCAAAAA-25436: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25436
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25436"),
