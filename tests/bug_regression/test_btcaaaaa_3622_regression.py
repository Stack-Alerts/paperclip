"""
Regression tests for BTCAAAAA-3622: add missing bug regression test file for
BTCAAAAA-1272.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-3622
...
the file for BTCAAAAA-1272 that was missing from the set of committed bug
