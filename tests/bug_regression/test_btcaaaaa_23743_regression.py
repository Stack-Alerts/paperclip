"""
Regression tests for BTCAAAAA-23743: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-23743
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-23743"),
