"""
Regression tests for BTCAAAAA-25528: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25528
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25528"),
