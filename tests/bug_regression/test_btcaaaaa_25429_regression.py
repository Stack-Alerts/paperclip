"""
Regression tests for BTCAAAAA-25429: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25429
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25429"),
