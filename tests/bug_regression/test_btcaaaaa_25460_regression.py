"""
Regression tests for BTCAAAAA-25460: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25460
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25460"),
