"""
Regression tests for BTCAAAAA-25579: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25579
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25579"),
