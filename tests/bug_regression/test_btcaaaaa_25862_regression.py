"""Regression tests for BTCAAAAA-25862: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25862
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25862"),
