"""Regression tests for BTCAAAAA-25916: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25916
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25916"),
