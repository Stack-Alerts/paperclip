"""
Regression tests for BTCAAAAA-24647: Blast Radius worker -- detect fix->in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-24647
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-24647"),
