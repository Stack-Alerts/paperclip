"""
Regression tests for BTCAAAAA-25807: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25807
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25807"),
