"""
Regression tests for BTCAAAAA-25811: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25811
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25811"),
