"""
Regression tests for BTCAAAAA-25849: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25849
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25849"),
