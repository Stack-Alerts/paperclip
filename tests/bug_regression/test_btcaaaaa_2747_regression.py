"""
Regression tests for BTCAAAAA-2747: add missing bug regression test file for
BTCAAAAA-1421.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2747
...
the file for BTCAAAAA-1421 that was missing from the set of committed bug
