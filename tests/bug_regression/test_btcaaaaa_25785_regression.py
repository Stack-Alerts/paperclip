"""
Regression tests for BTCAAAAA-25785: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25785
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25785"),
