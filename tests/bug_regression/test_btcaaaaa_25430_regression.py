"""
Regression tests for BTCAAAAA-25430: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25430
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25430"),
