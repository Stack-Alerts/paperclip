"""
Regression tests for BTCAAAAA-25836: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25836
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25836"),
