"""
Regression tests for BTCAAAAA-25933: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25933
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25933"),
