"""Regression tests for BTCAAAAA-25864: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25864
...
Root cause: N/A — parent orchestration issue.  The Blast Radius worker polls
...
issues on errors.  This is the top-level orchestration issue that spawned child
issues for individual regression test shims (BTCAAAAA-25854, BTCAAAAA-25856,
BTCAAAAA-25860, BTCAAAAA-25861).
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25864"),
