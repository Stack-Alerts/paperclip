"""
Regression tests for BTCAAAAA-25378: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25378
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25378"),
