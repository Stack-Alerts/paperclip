"""
Regression tests for BTCAAAAA-25837: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25837
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25837"),
