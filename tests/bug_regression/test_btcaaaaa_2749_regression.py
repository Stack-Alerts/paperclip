"""
Regression tests for BTCAAAAA-2749: add missing bug regression test file for
BTCAAAAA-1621.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2749
...
the file for BTCAAAAA-1621 that was missing from the set of committed bug
