"""
Regression tests for BTCAAAAA-25819: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25819
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25819"),
