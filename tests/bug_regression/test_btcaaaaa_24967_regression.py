"""
Regression tests for BTCAAAAA-24967: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-24967
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-24967"),
