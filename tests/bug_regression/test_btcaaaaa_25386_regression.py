"""
Regression tests for BTCAAAAA-25386: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25386
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25386"),
