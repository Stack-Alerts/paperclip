"""
Regression tests for BTCAAAAA-23716: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-23716
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-23716"),
