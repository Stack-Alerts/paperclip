"""
Regression tests for BTCAAAAA-25871: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25871
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25871"),
