"""
Regression tests for BTCAAAAA-25776: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25776
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25776"),
