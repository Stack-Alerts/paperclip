"""Regression tests for BTCAAAAA-25853: Impact Gate — scan for fix issues done.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25853
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25853"),
