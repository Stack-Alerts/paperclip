"""
Regression tests for BTCAAAAA-25450: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25450
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25450"),
