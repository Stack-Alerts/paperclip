"""
Regression tests for BTCAAAAA-2740: add missing bug regression test file for
BTCAAAAA-1573.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-2740
...
the file for BTCAAAAA-1573 that was missing from the set of committed bug
