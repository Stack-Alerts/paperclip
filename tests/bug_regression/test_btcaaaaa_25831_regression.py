"""
Regression tests for BTCAAAAA-25831: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25831
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25831"),
