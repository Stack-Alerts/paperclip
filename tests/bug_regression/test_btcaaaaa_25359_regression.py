"""
Regression tests for BTCAAAAA-25359: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25359
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25359"),
