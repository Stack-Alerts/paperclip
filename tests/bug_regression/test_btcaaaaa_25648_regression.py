"""
Regression tests for BTCAAAAA-25648: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25648
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25648"),
