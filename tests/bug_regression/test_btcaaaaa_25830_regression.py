"""
Regression tests for BTCAAAAA-25830: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25830
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25830"),
