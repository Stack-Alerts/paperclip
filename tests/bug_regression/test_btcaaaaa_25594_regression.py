"""
Regression tests for BTCAAAAA-25594: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25594
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25594"),
