"""
Regression tests for BTCAAAAA-26156: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-26156
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-26156"),
