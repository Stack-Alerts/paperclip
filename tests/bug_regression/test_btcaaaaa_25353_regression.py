"""
Regression tests for BTCAAAAA-25353: Touch Index bug-close ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25353
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25353"),
