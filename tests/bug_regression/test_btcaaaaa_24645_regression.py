"""
Regression tests for BTCAAAAA-24645: Blast Radius worker — detect fix→in_review
and post report.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-24645
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-24645"),
