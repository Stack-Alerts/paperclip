"""
Regression tests for BTCAAAAA-25800: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25800
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25800"),
