"""
Regression tests for BTCAAAAA-25385: Touch Index FR ingestion worker.

Issue: https://app.paperclip.ing/BTCAAAAA/issues/BTCAAAAA-25385
...
pytestmark = [
    pytest.mark.bug("BTCAAAAA-25385"),
