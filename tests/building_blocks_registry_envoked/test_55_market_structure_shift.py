"""
Registry Test: market_structure_shift
=====================================
Test ID: 55/83
Category: SMC_ICT
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test market_structure_shift via Registry')
    ...
    result = test_building_block_registry(
        block_name='market_structure_shift',
        days=args.days,
