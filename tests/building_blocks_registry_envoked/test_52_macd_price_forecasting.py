"""
Registry Test: macd_price_forecasting
=====================================
Test ID: 52/83
Category: SIGNALS
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test macd_price_forecasting via Registry')
    ...
    result = test_building_block_registry(
        block_name='macd_price_forecasting',
        days=args.days,
