"""
Registry Test: initial_balance_breakout
=======================================
Test ID: 44/83
Category: PATTERNS
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test initial_balance_breakout via Registry')
    ...
    result = test_building_block_registry(
        block_name='initial_balance_breakout',
        days=args.days,
