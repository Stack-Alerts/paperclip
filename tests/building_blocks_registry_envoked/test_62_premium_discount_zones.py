"""
Registry Test: premium_discount_zones
=====================================
Test ID: 62/83
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test premium_discount_zones via Registry')
    ...
    result = test_building_block_registry(
        block_name='premium_discount_zones',
        days=args.days,
