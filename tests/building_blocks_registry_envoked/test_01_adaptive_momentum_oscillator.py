"""
Registry Test: adaptive_momentum_oscillator
===========================================
Test ID: 01/83
Category: SIGNALS
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test adaptive_momentum_oscillator via Registry')
    ...
    result = test_building_block_registry(
        block_name='adaptive_momentum_oscillator',
        days=args.days,
