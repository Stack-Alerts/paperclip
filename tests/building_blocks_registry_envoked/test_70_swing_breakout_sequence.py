"""
Registry Test: swing_breakout_sequence
======================================
Test ID: 70/83
Category: PATTERNS
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test swing_breakout_sequence via Registry')
    ...
    result = test_building_block_registry(
        block_name='swing_breakout_sequence',
        days=args.days,
