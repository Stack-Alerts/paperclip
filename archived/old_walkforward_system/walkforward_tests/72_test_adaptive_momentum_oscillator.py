"""
Walk-Forward Test for Adaptive Momentum Oscillator
...
if __name__ == "__main__":
    from src.detectors.building_blocks.signals.adaptive_momentum_oscillator import AdaptiveMomentumOscillator
