...
Task 0.5: Database Migration Configuration

This module configures Alembic to use our database configuration
and models for automatic migration generation.
"""
