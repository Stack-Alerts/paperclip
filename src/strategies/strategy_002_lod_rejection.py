"""
Strategy: LOD Rejection
Number: 002
Category: 
Timeframe: 15-minute
Risk:Reward: 1:3
Author: Strategy Builder v1.0
Date: 2026-01-11 16:13:24
...
Risk Management:
- Risk per trade: 9.999999999999982%
- Max leverage: 10.0x
- Max bars held: 1000
"""
...
class StrategyLodRejection(Strategy):
    """
    LOD Rejection
...
# ============================================================================
# OPTIMIZED: 2026-01-11 16:13:38
# Trades: 34, Win Rate: 52.9%, PF: 1.05
# Net PnL: $163.54 (+0.65%)
# Fees: $1290.73
# Sharpe: 0.65, Max DD: 5.06%
# ============================================================================
    ...
    def __init__(self, config):
        ...
        self.strategy_id = "002_LOD_REJECTION"
        self.strategy_name = "LOD Rejection"
    ...
    def _initialize_blocks(self):
        ...
        self.detectors = {
            'lod_0': LOD(timeframe='15min'),
            'stochastic_rsi_1': StochasticRSI(timeframe='15min'),
        }
    ...
    def _analyze_blocks(self, df: pd.DataFrame) -> dict:
        ...
        # Lod
        results['lod_0'] = self.detectors['lod_0'].analyze(df)
        # Stochastic Rsi
        results['stochastic_rsi_1'] = self.detectors['stochastic_rsi_1'].analyze(df)
